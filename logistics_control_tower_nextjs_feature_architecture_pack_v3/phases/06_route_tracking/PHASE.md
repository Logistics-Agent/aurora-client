# PHASE 06 — ROUTE + TRACKING

## Objective

Implement route planning and realtime map/tracking.
...
Create `features/route-tracking` for Route Planning, Live Map, Tracking Detail, selected drawer, GPS stale/offline, realtime disconnected, map loading/error. Keep realtime transport separate from scene rendering. Shipment route tab is a contextual adapter, not a deep import into global feature internals.
