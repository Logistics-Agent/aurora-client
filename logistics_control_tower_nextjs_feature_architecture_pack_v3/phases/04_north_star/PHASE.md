...
Implement approved Operations Command Center + Shipment Detail visual/architectural DNA.
...
Create `features/command-center` and Shipment Detail shell in `features/shipment`. Include Global/Vietnam/Shipment-selected command-center states, Requires Attention, activity, Shipment hero/tabs/overview/route context. Add only 3D infrastructure actually required.
