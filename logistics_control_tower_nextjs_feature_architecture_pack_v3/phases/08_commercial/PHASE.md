...
Implement cost, negotiation, billing.
...
Create `features/commercial/{cost,negotiation,billing}`. Implement Cost Estimate, Negotiation Center/Detail, Billing List, Invoice Detail, plus Shipment contextual tabs. AI negotiation must never auto-send.
