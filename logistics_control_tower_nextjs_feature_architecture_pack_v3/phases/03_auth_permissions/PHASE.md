# PHASE 03 — AUTH + PERMISSIONS

## Objective

Implement Auth feature and permission boundaries without inventing backend auth.
...
Create `features/auth` for Login, Forgot Password, Select Tenant. Prepare current user/tenant and permission helper boundaries only from known contracts.
