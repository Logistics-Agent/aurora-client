...
Build shared infrastructure and primitives after initialization passes.
...
Create/refine HTTP client, ApiError, QueryClient/Provider, query-key convention, AppProvider, env, route/navigation constants, shared API response types, shadcn config, and genuinely shared DataTable/EmptyState/ErrorState/ConfirmationDialog/FilterBar foundations. Do not create Shipment UI.
