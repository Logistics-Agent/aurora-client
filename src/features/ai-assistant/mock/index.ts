...
export const shipmentRiskInsight: AiAnswerMock = {
  ...
  confidence: 87,
  reason: "Berth queue increased 34% and the vessel missed its original window.",
...
export const assistantAnswerMock: AiAnswerMock = {
  result: "SHP-2026-00128 is currently near Cat Lai Port with an ETA buffer of 35 minutes.",
  confidence: 91,
  reason: "The visible shipment timeline and route context show a port congestion flag.",
